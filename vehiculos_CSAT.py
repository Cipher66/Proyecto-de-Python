...
print(my_vehicleCSAT_Fighter)
print(my_vehicleCSAT_CarMR)
print(my_vehicleCSAT_CarLSV)
print(my_vehicleCSAT_CarTR)
print(my_vehicleCSAT_CarTRL)
print(my_vehicleCSAT_DronesR)
print(my_vehicleCSAT_DronesRP)
print(my_vehicleCSAT_DronesQ)
print(my_vehicleCSAT_HeloTH)
print(my_vehicleCSAT_HeloAT)
print(my_vehicleCSAT_HeloT)
